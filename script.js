...
function buildCalendar() {
  ...
  days.forEach((day) => {
    ...
    if (day.dot) button.classList.add("has-dot", day.dot === "pink" ? "has-pink" : "has-green");
    button.addEventListener("click", () => {
      document.querySelectorAll(".date").forEach((date) => date.classList.remove("is-selected"));
...
document.addEventListener("click", (event) => {
  ...
  if (quickMood) {
    document.querySelectorAll("[data-mood]").forEach((button) => button.classList.remove("is-selected"));
  ...
  if (moodButton) {
    document.querySelectorAll("[data-mood-pick]").forEach((button) => button.classList.remove("is-selected"));
